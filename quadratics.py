...
class quadratics:
  ...
  def __init__(self,a,b,c): 
    ...
    self.discriminant = (math.sqrt(((self.b**2)-(4*self.a*self.c))))/(2*self.a) #1
    #MAKE SURE DOESN'T EQUAL A NEGATIVE BEFORE SQUARE ROOT OR ELSE PROGRAM WILL CRASH
      
  #calculates the vertex of the function
  def calculateVertex(self):
    self.y = ((self.a*(self.x**2))+(self.b*self.x) +self.c)
    print('The vertex is at {' + str(self.x) + ',' + str(self.y) + '}') #-2,-2
